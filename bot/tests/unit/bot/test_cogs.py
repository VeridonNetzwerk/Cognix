"""Tests for bot.cogs.admin — verify cog classes can be instantiated."""
...
class TestAdminCogImport:
    ...
    def test_can_import_admin_cog(self):
        from bot.cogs.admin.admin import AdminCog
...
class TestMarketplaceCogImport:
    ...
    def test_can_import_marketplace_cog(self):
        from bot.cogs.admin.marketplace import MarketplaceCogCmd
